# Generated by Django 4.0.3 on 2022-07-10 14:50
...
class Migration(migrations.Migration):
    ...
    replaces = [('character', '0001_initial'), ('character', '0002_impact_skills_impact_statistics'), ('character', '0003_alter_alchemicalitem_effects_and_more'), ('character', '0004_remove_race_perk_race_perks'), ('character', '0005_alter_country_options_alter_familystatus_impacts_and_more')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ammunition', models.ManyToManyField(related_name='characters', to='character.ammunition')),
                ('armor', models.ManyToManyField(related_name='characters', to='character.armor')),
            ],
        ),
        migrations.CreateModel(
            name='Country',
        ...
        migrations.AddField(
            model_name='impact',
            name='skills',
            field=models.ManyToManyField(related_name='impacts', to='character.skillownership'),
        ),
        migrations.AddField(
            model_name='impact',
            name='statistics',
            field=models.ManyToManyField(related_name='impacts', to='character.statisticownership'),
        ),
        migrations.CreateModel(
            name='FamilyStatus',
            fields=[
        ...
        migrations.AlterField(
            model_name='character',
            name='ammunition',
            field=models.ManyToManyField(blank=True, related_name='characters', to='character.ammunition'),
        ),
        migrations.AlterField(
            model_name='character',
            name='armor',
            field=models.ManyToManyField(blank=True, related_name='characters', to='character.armor'),
        ),
        migrations.AddField(
            model_name='impact',
            name='skills',
            field=models.ManyToManyField(blank=True, to='character.skillownership'),
        ),
        migrations.AddField(
            model_name='impact',
            name='statistics',
            field=models.ManyToManyField(blank=True, to='character.statisticownership'),
        ),
        migrations.AlterField(
            model_name='profession',
            name='starting_armor',
            field=models.ManyToManyField(blank=True, to='character.armor'),
        ),
        migrations.AlterField(
            model_name='profession',
            name='starting_gear',
            field=models.ManyToManyField(blank=True, to='character.gear'),
        ),
        migrations.AlterField(
            model_name='profession',
            name='starting_skills',
            field=models.ManyToManyField(blank=True, to='character.skill'),
        ),
        migrations.AlterField(
            model_name='profession',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_standings', models.ManyToManyField(blank=True, to='character.socialstanding')),
            ],
        ),
        migrations.AlterField(
            model_name='skilltreeitem',
