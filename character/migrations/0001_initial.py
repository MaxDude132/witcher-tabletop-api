# Generated by Django 4.0.3 on 2022-06-23 19:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='race',
            name='perk',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='character.raceperk'),
        ),
        migrations.CreateModel(
            name='Profession',
            fields=[
        ...
        migrations.AddField(
            model_name='character',
            name='gear',
            field=models.ManyToManyField(related_name='characters', to='character.gear'),
        ),
        migrations.AddField(
            model_name='character',
            name='languages',
            field=models.ManyToManyField(related_name='characters', through='character.LanguageOwnership', to='character.language'),
        ),
        migrations.AddField(
            model_name='character',
            name='life_events',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='characters', through='character.SkillTreeItemOwnership', to='character.skilltreeitem'),
        ),
        migrations.AddField(
            model_name='character',
            name='skills',
        ...
        migrations.AddField(
            model_name='character',
            name='tool_kits',
            field=models.ManyToManyField(related_name='characters', to='character.toolkit'),
        ),
        migrations.AddField(
            model_name='character',
            name='weapons',
            field=models.ManyToManyField(related_name='characters', to='character.weapon'),
        ),
        migrations.CreateModel(
